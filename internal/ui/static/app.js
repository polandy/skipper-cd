(function () {
  ...
  // The one piece of the Logs view the container-logs panel (app-clog.js)
  // renders through; the rest of App.logs follows when the view moves out.
  App.logs = { renderLogLine };
