...
# Prettier/ESLint for the embedded UI's plain-script JS (app.js, app-state.js, app-chrome.js, app-panels.js, app-hosts.js, app-roster.js, app-deploys.js, app-autosync.js, app-logs.js, app-clog.js,
