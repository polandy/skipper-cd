...
| [0051](0051-adopt-running-stacks-on-empty-state.md) | `initial_deploy: adopt` — record the running stacks instead of deploying them all when no state is recorded |
