...
Every `modules/<name>/docker-compose.yml` is discovered as a stack automatically — no list to maintain. `webhook_secret` is required: it signs the webhook you wire up next.
