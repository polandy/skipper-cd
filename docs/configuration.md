...
health_watch:                      # cadence = health_poll_interval_seconds
  ...
  alert_cooldown_seconds: 0        # optional rate limit for repeat alerts of one service; 0 = off
