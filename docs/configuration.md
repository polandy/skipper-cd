...
- The repository is dropped from both sides when it is the same (the service name already says which image it is); a service that switched to a **different** image shows both references in full.
